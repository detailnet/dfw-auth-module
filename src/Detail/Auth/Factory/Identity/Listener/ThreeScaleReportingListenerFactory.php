    ...
    FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        /** @var \Detail\Auth\Identity\ThreeScaleTransactionRepositoryInterface $transactionRepository */
        $transactionRepository = $serviceLocator->get($threeScaleOptions->getReporting()->getRepository());

        return new Listener($transactionRepository);
    }
}
